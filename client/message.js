...
class Message extends Base {
 ...
 _patch(data) {
  ...
  Object.assign(this, {
   ...
   isViewOnce: Boolean(this.reply_message.viewOnceMessage),
 ...
 async sendMessage(
  ...
  const sendFunc = {
   ...
   interactive: async () => {
    ...
    return this.client.relayMessage(jid || this.jid, msg.message, {
     messageId: msg.key.id,
    });
   },
   sticker: async () => {
   ...
   location: () => {
    return this.client.sendMessage(jid || this.jid, {
     location: content,
     ...opt,
    });
   },
